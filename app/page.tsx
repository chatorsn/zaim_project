      ...
      <div className="relative z-10">
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/30 backdrop-blur-md border-b border-white/20">
          <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
            ...
            <Link href="/login" className="text-white border border-white/50 px-5 py-2 rounded-full hover:bg-white/20 transition">
              Войти
            </Link>
          </div>
        </header>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/login" className="bg-[#2E5A4C] text-white px-8 py-4 rounded-full font-medium hover:bg-[#3D6B5A] transition">
                  Получить займ
                </Link>
                <Link href="/how-it-works" className="bg-white/20 backdrop-blur border border-white/30 text-white px-8 py-4 rounded-full font-medium hover:bg-white/30 transition">
                  Как работает
                </Link>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                <div key={item.label} className="bg-white/15 backdrop-blur border border-white/20 rounded-3xl p-6">
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-10 bg-white/15 backdrop-blur border border-white/20 rounded-3xl p-8 lg:p-12">
              <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full accent-[#2E5A4C]"
                  />
                </div>
                <div>
                  <div className="flex justify-between text-white mb-2">
